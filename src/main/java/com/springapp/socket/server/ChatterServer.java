package com.springapp.socket.server;
 ...
 * ChatterServer.java
 *
 * Chatter server with NIO library
 *
 * @author <a href="mailto:slavrinov@gmail.com">slavrinov</a>
 * @version 1.0
 */
...
public class ChatterServer extends Thread {
    ...
    private void initServerSocket() {
	    try {
            ...
            log.severe("error initializing server"+ e.getMessage());
        }
        }
    ...
    private void acceptNewConnections() {
        try {
            ...
            log.severe("error during accept(): "+ ioe.getMessage());
        }
        catch (Exception e) {
            log.severe("exception in acceptNewConnections()"+ e.getMessage());
        }
    }
	...
	try {
	    ...
	    log.severe("error during select(): "+ ioe.getMessage());
	}
	catch (Exception e) {
	    log.severe("exception in run()"+ e.getMessage());
	}
